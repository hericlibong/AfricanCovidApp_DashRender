...
html.Div([
            html.H6(children='Africa Global Cases',
                    style={'textAlign': 'center',
                           'color': 'white'}),
...
html.Div([
            html.H6(children='Africa Global Deaths',
                    style={'textAlign': 'center',
                           'color': 'white'}),
...
def update_confirmed(w_countries):
    ...
    return {
        'data': [go.Indicator(
               mode='number+delta',
               value=int(value_confirmed),
               delta = {'reference': int(delta_confirmed),
                        'position': 'right',
                        #'valueformat': ',g',
                        'relative': False,
                        'font': {'size': 15}},
...
def update_confirmed(w_countries):
    ...
    return {
        'data': [go.Indicator(
               mode='number+delta',
               value=value_death,
               delta = {'reference': int(delta_death),
                        'position': 'right',
                        #'valueformat': ',g',
                        'relative': False,
                        'font': {'size': 15}},
...
def update_graph(w_countries):
    ...
    return {
        ...
        'layout': go.Layout(
            title={'text': 'Total Cases & Deaths in  ' + (w_countries).upper(),
                   'y': 0.93,
                   'x': 0.5,
                   'xanchor': 'center',
                   'yanchor': 'top'},
...
def update_graph(w_countries):
    ...
    return {
        ...
        'layout': go.Layout(
            title={'text': 'Last 30 Days Daily Confirmed Cases for  ' + (w_countries).upper(),
                   'y': 0.93,
                   'x': 0.5,
                   'xanchor': 'center',
                   'yanchor': 'top'},
